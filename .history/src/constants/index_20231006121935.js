  ...
  const projects = [
    {
      name: "Shoe Wear ",
      description:
        "Ecommerce Website for Shoes. ite is a basic website which build on React and Redux-toolkit.we can view the products and put them to cart and it will shows the total a",
      tags: [
        {
          name: "react",
